set -l commands "+version +help +list-fonts +list-keybinds +list-themes +list-colors +list-actions +ssh-cache +edit-config +show-config +explain-config +validate-config +show-face +crash-report +boo +new-window"
...
complete -c ghostty -n "not __fish_seen_subcommand_from $commands" -l window-padding-balance -r -f -a "false true equal" -d "The viewport dimensions are usually not perfectly divisible by the cell size."
...
complete -c ghostty -n "string match -q -- '+*' (commandline -pt)" -f -a "+version +help +list-fonts +list-keybinds +list-themes +list-colors +list-actions +ssh-cache +edit-config +show-config +explain-config +validate-config +show-face +crash-report +boo +new-window"
...
complete -c ghostty -n "__fish_seen_subcommand_from +show-config" -l no-pager -f
complete -c ghostty -n "__fish_seen_subcommand_from +explain-config" -l option -r -f
complete -c ghostty -n "__fish_seen_subcommand_from +explain-config" -l keybind -r -f
